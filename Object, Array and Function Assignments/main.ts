...
finalArray.push(
    stringArray.pop() as string,
    stringArray.splice(stringArray.indexOf("am"), 1)[0],
    stringArray.splice(stringArray.indexOf("a"), 1)[0],
    stringArray.shift() as string,
    stringArray.shift() as string,
    stringArray.pop() as string
)
...
const inventory: {name: string, model: string, price: number, quantity: number}[] = [];
